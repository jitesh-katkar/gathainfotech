        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              Spring Boot, AWS, Kafka, and modern web technologies. Transform your career 
              with our industry-focused training programs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/syllabus" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Syllabus
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Gathainfotech. All rights reserved.
            </p>
